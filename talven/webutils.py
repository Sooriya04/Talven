...
from talven import logger, get_setting
...
if TYPE_CHECKING:
    ...
    from talven.search import SearchQuery
    from talven.results import UnresponsiveEngine
...
exception_classname_to_text = {
    ...
    'talven.exceptions.TalvenEngineCaptchaException': gettext("CAPTCHA"),
    'talven.exceptions.TalvenEngineTooManyRequestsException': gettext("too many requests"),
    'talven.exceptions.TalvenEngineAccessDeniedException': gettext("access denied"),
    'talven.exceptions.TalvenEngineAPIException': gettext("server API error"),
    'talven.exceptions.TalvenEngineXPathException': parsing_error_text,
