...
exception_classname_to_text = {
    ...
    'talven.exceptions.SearxEngineCaptchaException': gettext("CAPTCHA"),
    'talven.exceptions.SearxEngineTooManyRequestsException': gettext("too many requests"),
    'talven.exceptions.SearxEngineAccessDeniedException': gettext("access denied"),
    'talven.exceptions.SearxEngineAPIException': gettext("server API error"),
    'talven.exceptions.SearxEngineXPathException': parsing_error_text,
