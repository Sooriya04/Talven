...
if typing.TYPE_CHECKING:
    import talven.preferences
    import talven.results
    from talven.search.processors import OnlineParamTypes
...
class SXNG_Request(flask.Request):
    ...
    *this* class definition, see type cast :py:obj:`sxng_request`.
    ...
    """list of talven.plugins.Plugin.id (the id of the plugins)"""

    preferences: "talven.preferences.Preferences"
    """The preferences of the request."""

    errors: list[str]
    """A list of errors (translated text) added by :py:obj:`talven.webapp` in
    case of errors."""
    ...
    :py:obj:`talven.webapp` to calculate the total time of the request."""

    render_time: float
    """Duration of the rendering, calculated and added by
    :py:obj:`talven.webapp`."""

    timings: list["talven.results.Timing"]
    """A list of :py:obj:`talven.results.Timing` of the engines, calculatid in
    and hold by :py:obj:`talven.results.ResultContainer.timings`."""
