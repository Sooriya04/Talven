...
class SettingsBrand(msgspec.Struct, kw_only=True, forbid_unknown_fields=True):
    ...
    .. code:: yaml
       ...
       brand:
         ...
         public_instances: https://talven.space
    ...
    public_instances: str = "https://talven.space"
    """If you host your own https://talven.space change this URL."""
    ...
    .. autoclass:: talven.brand.BrandCustom
       :members:
    """
