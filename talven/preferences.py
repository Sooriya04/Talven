...
from talven.locales import LOCALE_NAMES
...
class PluginsSetting(BooleanChoices):
    ...
    def __init__(self, default_value, plugins: Iterable[talven.plugins.Plugin]):
...
class ClientPref:
    ...
    # hint: talven.webapp.get_client_settings should be moved into this class
...
class Preferences:
    ...
    def __init__(
        ...
        plugins: talven.plugins.PluginStorage,
