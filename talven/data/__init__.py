...
def __getattr__(name: str) -> t.Any:
    ...
    log.debug("init talven.data.%s", name)
...
def ahmia_blacklist_loader() -> list[str]:
    ...
    names.  The MD5 values are fetched by::
      ...
      talven_extra/update/update_ahmia_blacklist.py

    This function is used by :py:mod:`talven.plugins.ahmia_filter`.
...
def gsa_useragents_loader() -> list[str]:
    ...
    suitable for Google.  The user agents are fetched by::
      ...
      talven_extra/update/update_gsa_useragents.py

    This function is used by :py:mod:`talven.engines.google`.
    ...
    log.debug("init talven.data.%s", "GSA_USER_AGENTS")
