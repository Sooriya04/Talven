...
from talven.data.core import get_cache, log
from talven.network import get as http_get

if t.TYPE_CHECKING:
    from talven.cache import CacheRowType
...
class TrackerPatternsDB:
    ...
    def load(self):
        log.debug("init talven.data.TRACKER_PATTERNS")
