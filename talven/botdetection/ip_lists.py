...
.. code:: toml
   ...
   pass_ip = [
     '167.235.158.251', # IPv4 of check.talven.space
...
SEARXNG_ORG = [
    ...
    '167.235.158.251',  # IPv4 check.talven.space
    '2a01:04f8:1c1c:8fc2::/64',  # IPv6 check.talven.space
]
"""Passlist of IPs from the SearXNG organization, e.g. `check.talven.space`."""
