...
from talven.cache import ExpireCache, ExpireCacheCfg
from talven.extended_types import sxng_request
from talven.wikidata_units import convert_to_si, convert_from_si
...
def _get_sxng_locale_tag() -> str:
    ...
    from talven import query
    from talven.preferences import ClientPref
...
class WindSpeed(msgspec.Struct, kw_only=True):
    ...
    .. hint::
       ...
       Working with unit ``Bft`` (:py:obj:`talven.wikidata_units.Beaufort`) will
