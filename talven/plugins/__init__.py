...
.. code:: python
   ...
   from talven.plugins import Plugin
   from talven.result_types import Answer
...
.. sidebar:: Further reading ..
   ...
   - :py:obj:`Result.filter_urls(..) <talven.result_types._base.Result.filter_urls>`

The :py:obj:`Result.filter_urls(..) <talven.result_types._base.Result.filter_urls>`
...
def initialize(app):
    STORAGE.load_settings(talven.get_setting("plugins"))
    STORAGE.init(app)
