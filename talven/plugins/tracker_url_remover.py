...
from talven.data import TRACKER_PATTERNS
...
if t.TYPE_CHECKING:
    ...
    from talven.result_types import Result, LegacyResult  # pyright: ignore[reportPrivateLocalImportUsage]
    from talven.plugins import PluginCfg


log = logging.getLogger("talven.plugins.tracker_url_remover")
