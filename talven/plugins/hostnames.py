...
from talven.result_types._base import MainResult, LegacyResult
from talven.settings_loader import get_yaml_cfg
from talven.plugins import Plugin, PluginInfo
...
if t.TYPE_CHECKING:
    ...
    from talven.result_types import Result
    from talven.plugins import PluginCfg
