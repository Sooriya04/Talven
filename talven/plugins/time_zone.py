...
from talven.weather import DateTime, GeoLocation
...
class SXNGPlugin(Plugin):
    ...
    def post_search(self, request: "SXNG_Request", search: "SearchWithPlugins") -> EngineResults:
        """The plugin uses the :py:obj:`talven.weather.GeoLocation` class, which
        is already implemented in the context of weather forecasts, to determine
        the time zone. The :py:obj:`talven.weather.DateTime` class is used for
