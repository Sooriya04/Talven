...
from talven.data import OSM_KEYS_TAGS, CURRENCIES
from talven.external_urls import get_external_url
from talven.engines.wikidata import send_wikidata_query, sparql_string_escape, get_thumbnail
