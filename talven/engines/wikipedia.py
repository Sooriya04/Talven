...
from talven import network as _network
...
def fetch_wikimedia_traits(engine_traits: EngineTraits):
    ...
    known from :py:obj:`talven.locales.LOCALE_NAMES` or those with a minimal
    :py:obj:`editing depth <wikipedia_article_depth>`.

    The location of the Wikipedia address of a language is mapped in a
    :py:obj:`custom field <talven.enginelib.traits.EngineTraits.custom>`
