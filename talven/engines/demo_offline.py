...
if t.TYPE_CHECKING:
    from talven.search.processors import RequestParams
...
def setup(engine_settings: dict[str, t.Any]) -> bool:
    ...
    For more details see :py:obj:`talven.enginelib.Engine.setup`.
    """
...
def init(engine_settings: dict[str, t.Any]) -> bool:  # pylint: disable=unused-argument
    ...
    For more details see :py:obj:`talven.enginelib.Engine.init`.
    """
    return True
