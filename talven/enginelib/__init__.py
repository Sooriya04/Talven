...
- :py:obj:`talven.enginelib.EngineCache`
- :py:obj:`talven.enginelib.Engine`
- :py:obj:`talven.enginelib.traits`
...
.. hint::
   ...
   - move implementations of the :ref:`talven.engines loader` to a new module in
     the :py:obj:`talven.enginelib` namespace.
...
if t.TYPE_CHECKING:
    from talven.enginelib import traits
    ...
    from talven.search.processors import OfflineParamTypes, OnlineParamTypes
...
"""Global :py:obj:`talven.cache.ExpireCacheSQLite` instance where the cached
...
class EngineCache:
    ...
    <talven.cache.ExpireCacheCfg.MAXHOLD_TIME>`).  This class is a wrapper around
    :py:obj:`ENGINES_CACHE` (:py:obj:`ExpireCacheSQLite
    <talven.cache.ExpireCacheSQLite>`).
...
class Engine(abc.ABC):  # pylint: disable=too-few-public-methods
    ...
    engine_type: str
    """Type of the engine (:ref:`talven.search.processors`)"""
