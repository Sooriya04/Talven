...
their mapping from talvenNG's representation to the representation in the origin
...
from talven.data import data_dir, ENGINE_TRAITS
...
class EngineTraits:
    ...
    def get_language(self, searxng_locale: str, default: t.Any = None):
        ...
        :py:obj:`talven.locales.get_engine_locale`.  Except for the special value ``all``
    ...
    def set_traits(self, engine: "Engine | types.ModuleType"):
        ...
        :param engine: engine instance build by :py:func:`talven.engines.load_engine`
        """
...
class EngineTraitsMap(dict[str, EngineTraits]):
    ...
    def fetch_traits(cls, log: t.Callable[[str], None]) -> 'EngineTraitsMap':
        from talven import engines  # pylint: disable=cyclic-import, import-outside-toplevel
