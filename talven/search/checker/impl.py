...
from talven import network, logger
...
from talven.search.processors import EngineProcessor
from talven.metrics import counter_inc


logger = logger.getChild('talven.search.checker')
