...
from talven.locales import LOCALE_NAMES, locales_initialize
from talven.engines import wikidata, set_loggers
from talven.data.currencies import CurrenciesDB
...
def main():
    ...
    # talven.search.processors.online_currency.name_to_iso4217
